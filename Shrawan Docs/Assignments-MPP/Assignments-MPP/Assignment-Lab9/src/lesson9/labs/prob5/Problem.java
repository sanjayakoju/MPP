...
public class Problem {
    ...
    public static List<String> elementsInBoth(List<String> list1, List<String> list2) {
        // implement
        List<String> elementsInBoth = list1
                .stream()
    ...
    public static List<String> getZipsOfSpecialCustomers(List<Customer> list) {
        // implement
        List<String> customerZips = list
                .stream()
                .sorted(Comparator.comparing(customer -> customer.getZip()))
                .filter(customer -> customer.getCity().length() >= 6 && customer.getCity().indexOf('e') == -1)
