...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nAll members");
		dept.showAllMembers();
		dept.showAllMembersLS();
		
		System.out.println("\nTotal units for each Faculty:");
		//dept.unitsPerFaculty();
		dept.unitsPerFacultyLS();
		
		System.out.println("\nStudents by a given Faculty:");
		dept.showStudentNamesByFacultyLS("Frank Moore");  //"John Doodle" , "Sam Howard" , "Frank Moore"
